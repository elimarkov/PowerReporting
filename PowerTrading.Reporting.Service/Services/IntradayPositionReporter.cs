...
{
    private const string ReportGenerationPipelineName = "ReportGeneration";
    ...
    public IntradayPositionReporter(
        ...
        [FromKeyedServices("ReportGeneration")]
    ...
    private async void OnReportTriggered(object? _, TriggerEventArgs e)
    {
        ...
        try
        {
            ...
            var pipeline = _resilienceProvider.GetPipeline(ReportGenerationPipelineName);
